...
urlpatterns = [
    ...
    path('clubs/<slug:slug>/posts/<int:post_id>/edit/', views.edit_post, name='edit_post'),
    ...
    path('clubs/<slug:slug>/posts/<int:post_id>/bookmark/', views.toggle_bookmark, name='toggle_bookmark'),
